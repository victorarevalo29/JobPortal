          ...
          <form class="job-form" @submit.prevent="handleSubmit">
            ...
            <div class="field" :class="{ 'has-error': fieldErrors.description }">
              ...
              <textarea
                ...
                rows="4"
                placeholder="Comparte contexto sobre el reto"
            ...
            <div class="job-form__actions">
              ...
              <p v-if="submissionMessage" :class="['job-form__feedback', submissionType]">{{ submissionMessage }}</p>
            </div>
          </form>
        </BaseCard>
      </section>
...
const fieldErrors = reactive({ description: '' })
...
const validateDescription = () => {
  ...
  if (length && length < 40) {
    fieldErrors.description = 'Escribe al menos 40 caracteres.'
    return false
  }
  if (!length) {
    fieldErrors.description = 'Describe brevemente el reto y responsabilidades.'
    return false
  }
  fieldErrors.description = ''
  return true
...
const handleSubmit = async () => {
  ...
  try {
    if (isEditing.value) {
      ...
      submissionMessage.value = 'Vacante actualizada'
    } else {
      await jobsStore.createJob(payload)
      submissionType.value = 'success'
      submissionMessage.value = 'Vacante publicada'
    }
    resetForm()
  } catch (error) {
    submissionMessage.value = error?.message || jobsStore.error || 'No se pudo guardar la vacante'
  }
}
...
.job-form .field.has-error textarea {
...
.job-form__feedback.error {
  color: var(--clr-danger, #dc2626);
}

.job-form__feedback.success {
